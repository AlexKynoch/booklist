...
exports.create = function (req, res, next) {
    ...
    booklist.push({ id: idno, title: req.body.title, author: req.body.author, read: req.body.read }) //get whats in body and push into array post  http://localhost:3005/book/create and get http://localhost:3005/books to see results
